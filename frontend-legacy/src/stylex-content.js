...
export const contentStyles = stylex.create({
  ...
  focusLauncher: {
    ...
    backgroundImage:
      'radial-gradient(circle at 100% 0%, rgba(167, 139, 250, 0.22), transparent 28rem), radial-gradient(circle at 0% 100%, rgba(45, 212, 191, 0.12), transparent 30rem)'
  },
  focusKicker: {
    margin: 0,
  ...
  focusChoice: {
    ...
    minHeight: 'clamp(13rem, 28vw, 19rem)',
    padding: '1.4rem',
    borderWidth: 1,
    borderStyle: 'solid',
    borderColor: c.borderStrong,
    borderRadius: c.appRadius,
    backgroundColor: c.appSheet,
    color: c.text,
    boxShadow: c.appShadow,
    overflow: 'hidden',
    textAlign: 'left',
    transition:
      'transform 180ms ease, background-color 180ms ease, box-shadow 180ms ease',
    ':hover': {
      backgroundColor: c.appSheetRaised,
      boxShadow: c.shadowCardHover,
      transform: 'translateY(-4px)'
    },
    ':focus-visible': { boxShadow: `0 0 0 3px ${c.appPrimary}` }
  },
  focusChoiceEyebrow: {
    color: c.textSecondary,
    fontSize: '0.72rem',
  ...
  focusThemeToggle: {
    ...
    fontSize: '0.72rem',
    fontWeight: 700,
    ':hover': { backgroundColor: c.appPrimaryMuted, color: c.text },
    ':focus-visible': { boxShadow: `0 0 0 2px ${c.appPrimary}` }
  },
  focusThemeToggleInline: { marginTop: 0 },
  focusError: {
    position: 'fixed',
    zIndex: 50,
    top: '1rem',
  ...
  focusPanelLayout: {
    ...
    '@media (min-width: 900px)': {
      gridTemplateColumns: 'minmax(0, 1fr) minmax(22rem, 30rem)',
  ...
  focusFeature: {
    ...
    borderStyle: 'solid',
    borderColor: c.border,
    borderRadius: c.appRadiusSmall,
    backgroundColor: c.appSheetRaised,
    color: c.text,
    textAlign: 'left',
    transition: 'transform 160ms ease, background-color 160ms ease',
    ':hover': {
      backgroundColor: c.appPrimaryMuted,
  ...
  // Image gallery grid and lightbox overlay.
  galleryGrid: {
    display: 'grid',
  ...
  lightboxNavPrev: { left: '1rem' },
  lightboxNavNext: { right: '1rem' },
  lightboxCounter: {
