...
export const fileBrowserPlugin = defineFrontendPlugin({
  id: 'files',
  index: '16',
  title: 'File Browser',
  description: 'Browse directories, inspect files, and manage local media.',
  tone: 'teal',
  symbol: 'FOLDER',
  component: FileBrowser
});

export const imageGalleryPlugin = defineFrontendPlugin({
  id: 'gallery',
  index: '17',
  title: 'Image Gallery',
  description: 'Browse image directories and view them in a lightbox.',
  tone: 'purple',
  symbol: 'IMAGE',
