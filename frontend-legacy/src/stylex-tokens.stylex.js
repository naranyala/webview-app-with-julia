...
export const tokens = stylex.defineVars({
  // Semantic app-shell tokens. New UI should prefer these to raw hue names;
  // the older color tokens remain for feature compatibility during migration.
  appCanvas: '#0b1020',
  appSheet: '#131b31',
  appSheetRaised: '#1b2640',
  appPrimary: '#a78bfa',
  appPrimaryMuted: 'rgba(167, 139, 250, 0.18)',
  appOnPrimary: '#17122b',
  appShadow: '0 18px 45px rgba(2, 6, 23, 0.32)',
  appRadius: '20px',
  appRadiusSmall: '14px',
  bg: '#111318',
  surface: '#191d25',
...
export const lightTheme = stylex.createTheme(tokens, {
  appCanvas: '#f6f7fb',
  appSheet: '#ffffff',
  appSheetRaised: '#eef0f8',
  appPrimary: '#6555c8',
  appPrimaryMuted: 'rgba(101, 85, 200, 0.14)',
  appOnPrimary: '#ffffff',
  appShadow: '0 18px 45px rgba(39, 42, 68, 0.12)',
  appRadius: '20px',
  appRadiusSmall: '14px',
  bg: '#f4f1ea',
  surface: '#fffdf8',
